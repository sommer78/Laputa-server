...
app.config(['NgAdminConfigurationProvider', function (nga) {
    ...
    var admin = nga.application('Laputa Administration', false)
                        ...
                        .targetFields([
                            ...
                            nga.field('boardType', 'choice')
                              .choices([
                                ...
                                {value: 'SparkFun Laputa Board', label: 'SparkFun Laputa Board'},
    ...
    libraryVersion.listView()
        ...
        .sortField('count')
        .fields([
            nga.field('name').label('Laputa library version'),
