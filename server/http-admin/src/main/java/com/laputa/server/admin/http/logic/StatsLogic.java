...
import com.laputa.server.admin.http.response.IpNameResponse;
import com.laputa.server.admin.http.response.RequestPerSecondResponse;
...
import static com.laputa.utils.AdminHttpUtil.*;
