...
public class PinStorageSerializationTest {
    ...
    public void testDeserialize() throws Exception{
        String expectedString = "{\"email\":\"123\",\"appName\":\"Laputa\",\"lastModifiedTs\":0,\"lastLoggedAt\":0,\"profile\":{\"dashBoards\":[{\"id\":0,\"createdAt\":0,\"updatedAt\":0,\"theme\":\"Laputa\",\"keepScreenOn\":false,\"isShared\":false,\"isActive\":false," +
                "\"pinsStorage\":{\"0-v0\":\"0\",\"0-d1\":\"1\"}" +
                "}]},\"isFacebookUser\":false,\"energy\":2000,\"id\":\"123-Laputa\"}";
